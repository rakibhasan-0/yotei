		...
		checkID(id) ?
			(
				<div id={id} className={styles["sc23-session-container"]}>
					<div id={`${id}-header`} className={passed != undefined ? (passed ? styles["sc23-session-container-header-passed"] : styles["sc23-session-container-header-failed"]) : styles["sc23-session-container-header-undefined"]}>
