...
import styles from "./EditableListTagItem.module.css"
 ...
 * @since 2024-05-20
 */
export default function EditableListTagItem({ item, id, index, onRemove, onEdit, onCheck, showCheckbox, checked, validateInput, grayTrash }) {
