...
public class WorkoutController {
    ...
    public ResponseEntity<Workout> postFullWorkout(@RequestBody WorkoutDataPackage data){
        ...
        if (workout == null) {return new ResponseEntity<>(HttpStatus.BAD_REQUEST);}
    ...
    public ResponseEntity<Workout> updateFullWorkout(@RequestBody WorkoutDataPackage data){
        ...
        if (workout == null || workout.getId() == null) { return new ResponseEntity<>(workout, HttpStatus.BAD_REQUEST);}
        ...
        } else {return new ResponseEntity<>(workout, HttpStatus.NOT_FOUND);}
    }
