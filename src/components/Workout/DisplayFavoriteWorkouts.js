/**
 * This class displays the favorite workouts of a user.
 *
 * @author Hot-pepper (Group 7) (2022-05-17)
 */
...
const DisplayFavoriteWorkouts = () => {
	...
	function getFavoriteWorkouts() {
		...
		fetch(`/api/workouts/favorites/${userId}`, requestOptions)
...
export default DisplayFavoriteWorkouts
