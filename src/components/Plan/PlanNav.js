	...
	return (
		<>
			<nav>
				...
				{isActiveFilter &&
                    <div id="dropdownfilter"><DropDownPlan plans={props.plans} setPlanFunction={props.setPlanFunction} checkedChange={props.checkedChange} toggleAll={props.toggleAll}/>
                    </div>
				}
				{isActiveCal &&
                  <div id="dropdownCalendar"><center><PlanCalendar id="calendarDiv"/></center>
                  </div>
				}
			</nav>
