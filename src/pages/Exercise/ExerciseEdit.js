...
class ExerciseEdit extends React.Component {
    ...
    async removeTag(ex_id, tag_id, tag_name) {
        ...
        try {
            ...
            if (response.ok) {
                this.state.tagRemoveFailed = false;
                this.forceUpdate();
            } else {
                this.state.tagRemoveFailed = true;
    ...
    async linkExerciseTag(ex_id, tag_id, tag_name) {
        ...
        try {
            ...
            if (response.ok) {
                this.state.tagLinkFailed = false;
                this.forceUpdate();
            } else {
                this.state.tagLinkFailed = true;
                this.setState({errorName: tag_name})
                this.forceUpdate();
            }
        } catch (error) {
    ...
    render() {
        ...
        if (this.state.editFailed) {
            failedAlert = <div class="alert alert-danger" role="alert">
